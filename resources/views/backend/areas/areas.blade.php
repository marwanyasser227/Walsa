...
@section('dash')
    ...
    <div class="bg-gradient-dark shadow-dark border-radius-lg px-4 py-3">
        <h6 class="text-white text-capitalize ps-3">جدول المناطق</h6>
            ...
            <table class="table align-items-center mb-0">
                <thead>
                    <tr>
                        ...
                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">تكلفة الشحن
                            </th>
                ...
                <tbody>
                    ...
                    <!-- create Button -->
        <a href="{{route('areas.create')}}" class="btn btn-dark btn-md">إنشاء منطقة</a>
